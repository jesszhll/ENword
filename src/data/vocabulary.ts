...
export const VOCABULARY_DATA: VocabularyItem[] = [
  ...
  { id: 7, chinese: "打篮球", english: "play basketball", alternatives: ["playbasketball"], example: "We play basketball after school.", exampleChinese: "我们放学后打篮球。" },
  { id: 8, chinese: "打乒乓球", english: "play table tennis", alternatives: ["play ping pong", "play ping-pong", "ping pong", "ping-pong", "table tennis"], example: "My friend and I play table tennis.", exampleChinese: "我和我的朋友打乒乓球。" },
  ...
  { id: 126, chinese: "电脑室", english: "computer room", alternatives: ["computer lab", "computerroom"], example: "We learn how to type in the computer room.", exampleChinese: "我们在电脑室里学习怎么打字。" },
  ...
  { id: 134, chinese: "书包", english: "schoolbag", alternatives: ["backpack", "school bag"], example: "I pack my schoolbag every evening.", exampleChinese: "我每天晚上整理我的书包。" },
  ...
  { id: 144, chinese: "（去电影院）看电影", english: "go to the cinema", alternatives: ["see a movie", "watch a movie", "go to the movies", "cinema", "movie", "see a film", "watch a film"], example: "We will go to the cinema this evening.", exampleChinese: "我们今晚要去电影院看电影。" },
